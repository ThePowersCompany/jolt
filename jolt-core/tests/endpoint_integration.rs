//! JOLT-RS-045 PRD-mandated integration test.
//!
//! Verifies the end-to-end path: `#[endpoint("/ping")]` with a `#[get]` method
//! → inventory registration → `JoltServer::into_router()` → GET /ping returns
//! 200 with the expected body and Content-Type.

use axum::body::{to_bytes, Body};
use axum::http::Request as AxumRequest;
use jolt_core::{endpoint, JoltServer, Response, StatusCode};
