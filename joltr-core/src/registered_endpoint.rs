...
//! [`crate::JoltRServer::start`] (JOLTR-RS-044) iterates
...
//!
//! `handler` is a bare `fn` pointer (added in JOLTR-RS-044), not a closure or a
...
//! `<UserType>::__jolt_handler_<user_fn>` (JOLTR-RS-043's wrapper) into this
